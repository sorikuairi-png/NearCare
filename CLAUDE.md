...
## Screenshot Workflow
- Puppeteer is installed locally in this project (`node_modules/puppeteer`); the downloaded Chrome binary is cached at `~/.cache/puppeteer/` — no machine-specific setup needed.
